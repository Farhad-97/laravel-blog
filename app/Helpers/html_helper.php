<?php
 ...
 function textArea($config){
   ...
   $id=isset($config["value_column"])?$config["value_column"]:"id";  
   $name=isset($config["display_column"])?$config["display_column"]:"name";  
   $rows=isset($config["display_rows"])?$config["display_rows"]:"";  
   $cols=isset($config["display_cols"])?$config["display_cols"]:"";  
   ...
   $html.="<label class='col-sm-2 col-form-label'>{$config["label"]}</label>";
   $html.="<div class='col-sm-10'>"; 
   $html.="<textarea name='{$config["name"]}' rows='{$config["rows"]}' cols='{$config["cols"]}' class='form-control'>";
